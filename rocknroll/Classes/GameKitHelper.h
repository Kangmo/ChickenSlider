...
@interface GameKitHelper : NSObject <GKLeaderboardViewControllerDelegate, GKAchievementViewControllerDelegate, GKMatchmakerViewControllerDelegate, GKMatchDelegate>
{
	...
	id<GameKitCommProtocol> commDelegate;
...
@property (nonatomic, retain) id<GameKitCommProtocol> commDelegate;
...
@property (nonatomic, retain)   NSArray* currentMatchPlayers; // Array of GKPlayer
@property (nonatomic, readonly) bool matchStarted;
@property (nonatomic, readonly) NSString* localPlayerAlias;
